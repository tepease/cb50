...
#### <a name='puzzlepieces'></a> puzzle pieces

As you play around with your Scratch project, think about what each different type of puzzle piece is doing. 
...
### <a name='cowsay'></a> cowsay

1. find out what package manager your shell has, or download one (like aptitude, npm or gulp)
2. install the classic command line tool, cowsay
3. install fortune
4. make your cow tell you fortunes with the | 'pipe' operator: fortune | cowsay
5. make your cow tell you a fortune every time you open a command prompt